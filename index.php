...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            ...
            <?php foreach ($items as $offers): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$offers['image']; ?>" width="350" height="260" alt="<?=$offers['name']; ?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$offers['categoty']; ?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$offers['name']; ?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=$offers['price']; ?><b class="rub">р</b></span>
                        </div>
